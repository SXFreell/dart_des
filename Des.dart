...
*/  
class DES {
  static String strEnc(data, firstKey, secondKey, thirdKey) {
...
*/
  static String strDec(data, firstKey, secondKey, thirdKey) {
    int leng = data.length;
    String decStr = "";
    List<List<int>> firstKeyBt=[], secondKeyBt=[], thirdKeyBt=[];
...
* return string 
*/
  static String byteToString(byteData) {
    String str = "";
    for (int i = 0; i < 4; i++) {
      int count = 0;
      for (int j = 0; j < 16; j++) {
  ...
  static String bt64ToHex(byteData) {
    String hex = "";
    for (int i = 0; i < 16; i++) {
      String bt = "";
      for (int j = 0; j < 4; j++) {
...
*/
  ...
  static List<int> enc(dataByte, keyByte) {
  ...
  static List<int> dec(dataByte, keyByte) {
    List<List<int>>? keys = generateKeys(keyByte);
    List<int> ipByte = initPermute(dataByte);
    List<int> ipLeft = List.filled(32, 0);
    List<int> ipRight = List.filled(32, 0);
  ...
  static List<int> initPermute(originalData) {
  ...
  static List<int> expandPermute(rightData) {
  ...
  static List<int> xor(byteOne, byteTwo) {
  ...
  static List<int> sBoxPermute(expandByte) {
  ...
  static List<int> pPermute(sBoxByte) {
  ...
  static List<int> finallyPermute(endByte) {
